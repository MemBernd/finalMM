...
CREATE TABLE IF NOT EXISTS `sep`.`Task` (
  ...
  CONSTRAINT `fk_Task_Employee2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Task_EventRequestStatus1`
...
CREATE INDEX `fk_Task_EventRequestStatus1_idx` ON `sep`.`Task` (`statusId` ASC);
...
CREATE TABLE IF NOT EXISTS `sep`.`FinancialRequest` (
  ...
  CONSTRAINT `fk_FinancialRequest_Task1`
    FOREIGN KEY (`idTask`)
...
CREATE INDEX `fk_FinancialRequest_Task1_idx` ON `sep`.`FinancialRequest` (`idTask` ASC);
...
CREATE TABLE IF NOT EXISTS `sep`.`StaffRequest` (
  ...
  CONSTRAINT `fk_StaffRequest_Task1`
    FOREIGN KEY (`idTask`)
    REFERENCES `sep`.`Task` (`idTask`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_StaffRequest_Task1_idx` ON `sep`.`StaffRequest` (`idTask` ASC);
...
CREATE INDEX `fk_Plan_Task1_idx` ON `sep`.`Plan` (`idTask` ASC);
...
INSERT INTO `sep`.`EventRequestStatus` (`idEventRequestStatus`, `status`) VALUES (14, 'budgetNegotiated');
INSERT INTO `sep`.`EventRequestStatus` (`idEventRequestStatus`, `status`) VALUES (15, 'pendingPlan');
INSERT INTO `sep`.`EventRequestStatus` (`idEventRequestStatus`, `status`) VALUES (16, 'planRejected');
...
INSERT INTO `sep`.`Employee` (`username`, `password`, `role`) VALUES ('diana', 'diana', 'Chef');
INSERT INTO `sep`.`Employee` (`username`, `password`, `role`) VALUES ('chris', 'chris', 'Chef');
INSERT INTO `sep`.`Employee` (`username`, `password`, `role`) VALUES ('daniel', 'daniel', 'Chef');
INSERT INTO `sep`.`Employee` (`username`, `password`, `role`) VALUES ('marilyn', 'marilyn', 'Chef');
INSERT INTO `sep`.`Employee` (`username`, `password`, `role`) VALUES ('don', 'don', 'Decoration');
INSERT INTO `sep`.`Employee` (`username`, `password`, `role`) VALUES ('tom', 'tom', 'Decoration');
